...
<body>
  ...
  <div class="card">
    ...
    <div class="row"><button onclick="runTest('typing:vscode-type-chunked')">VSCode type Chunked</button><button onclick="runTest('typing:vscode-paste-commands')">VSCode Paste Commands</button><button onclick="runTest('typing:vscode-insert-snippet')">VSCode InsertSnippet</button></div>
    <div class="row"><button onclick="runTest('typing:cdp-key-stream')">CDP Key Stream</button><button onclick="runTest('typing:bridge-chat-command')">Bridge Chat Command</button><button onclick="runTest('typing:composition-events')">Composition Events</button></div>
