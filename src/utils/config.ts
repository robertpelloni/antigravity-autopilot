...
export class ConfigManager {
    ...
    getAll(): AntigravityConfig {
        ...
        return {
            ...
            runtimeAutoResumeMessage: config.get('runtimeAutoResumeMessage', 'Proceed'),
            runtimeAutoResumeUseMinimalContinue: config.get('runtimeAutoResumeUseMinimalContinue', true),
            runtimeAutoResumeMinimalMessage: config.get('runtimeAutoResumeMinimalMessage', 'Proceed'),
            runtimeAutoResumeMinimalMessageVSCode: config.get('runtimeAutoResumeMinimalMessageVSCode', 'Proceed'),
            runtimeAutoResumeMinimalMessageAntigravity: config.get('runtimeAutoResumeMinimalMessageAntigravity', 'Proceed'),
            runtimeAutoResumeMinimalMessageCursor: config.get('runtimeAutoResumeMinimalMessageCursor', 'Proceed'),
