...
- [ ] P2.4 Project manager integrations hardening *(in progress: GitHub issue sync now supports pagination, rate-limit metadata, and persisted sync snapshots; Jira integration hardening still pending)*
